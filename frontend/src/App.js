...
function App() {
  ...
  return (
    ...
    <div className="App">
      ...
      <br />
      <div className="post">
      <strong>TITLE ---</strong><input  type="text" placeholder="Enter Title.." onChange={(e) => setTitle(e.target.value)} />
      <br />
      <strong>DESCRIPTION ---</strong>
      <input type="description" placeholder="Enter Description.." onChange={(e) => setDescription(e.target.value)} />
      <br />
